...
export default function MainDashboard() {
    ...
    useEffect(() => {
        if (selectedPrediction) {
            ...
            updatePredictionContext(selectedPrediction, factors, selectedPrediction.city || selectedCity || 'Selected City', timeOfDay);
        }
    ...
    useEffect(() => {
        ...
        if (selectedPrediction) {
            ...
            if (rankings && rankings.length > 0) {
                ...
                const highRiskCount = rankings.filter(city => city.riskLevel === 'CRITICAL' || city.riskLevel === 'HIGH').length;
    ...
    useEffect(() => {
        ...
        Object.entries(markersRef.current).forEach(([cityName, marker]) => {
            marker.setPopupContent(`<div style="font-size: 12px; color: #111827;"><p style="margin: 0; font-weight: bold;">${cityName}</p><p style="margin: 4px 0 0 0; color: #6b7280;">${sub}</p></div>`);
        });
        if (selectedPrediction)
            updateMapFromPrediction(selectedPrediction);
    ...
    return (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { children: [_jsx("h1", { className: "text-xl font-semibold text-gray-900", children: t("dashboardTitle") }), _jsx("p", { className: "text-sm text-gray-500 mt-1", children: t("dashboardSubtitle") })] }), _jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [_jsx(motion.div, { initial: { scale: 0.95 }, animate: { scale: 1 }, transition: { duration: 0.3 }, children: _jsx(KPICard, { title: t("nationalRiskIndex"), value: kpiData.nationalRisk.toFixed(1), subtitle: t("monitoredZones"), icon: Shield, accentColor: "orange", trend: "up", trendValue: `${kpiData.trend} ${t("trendBaseline")}` }) }, kpiData.nationalRisk), _jsx(motion.div, { initial: { scale: 0.95 }, animate: { scale: 1 }, transition: { duration: 0.3, delay: 0.1 }, children: _jsx(KPICard, { title: t("highRiskZonesActive"), value: kpiData.highRiskZones, subtitle: t("aboveThreshold"), icon: MapPin, accentColor: "red" }) }, kpiData.highRiskZones), _jsx(motion.div, { initial: { scale: 0.95 }, animate: { scale: 1 }, transition: { duration: 0.3, delay: 0.2 }, children: _jsx(KPICard, { title: t("alertsGenerated"), value: kpiData.alertsGenerated, subtitle: t("requiringAttention"), icon: AlertTriangle, accentColor: "orange", trend: "up", trendValue: `+${Math.floor(kpiData.alertsGenerated / 3)} ${t("newAlerts")}` }) }, kpiData.alertsGenerated), _jsx(KPICard, { title: t("modelConfidence"), value: `${kpiData.modelConfidence}%`, subtitle: t("predictionAccuracy"), icon: Activity, accentColor: "green", trend: "up", trendValue: `+1.8% ${t("improvement")}` })] }), _jsx(CrimePredictionModel, { onPredictionHourChange: setSelectedPredictionHour, onPredictionChange: handlePredictionChange }), _jsxs("div", { className: "rounded-lg bg-white/95 border border-gray-200 overflow-hidden", children: [_jsxs("div", { className: "p-4 border-b border-gray-200 flex items-center justify-between", style: { borderTopWidth: 3, borderTopColor: '#000080' }, children: [_jsxs("div", { children: [_jsx("h3", { className: "font-semibold text-gray-900", children: t("realTimeRiskMap") }), _jsx("p", { className: "text-xs text-gray-500 mt-1", children: t("liveMLPredictions") })] }), _jsxs("div", { className: "flex items-center gap-2 px-3 py-1.5 rounded-lg bg-green-50 border border-green-200", children: [_jsx("span", { className: "w-2 h-2 rounded-full bg-green-600 animate-pulse" }), _jsx("span", { className: "text-xs font-medium text-green-800", children: t("liveMLData") })] }), _jsxs("div", { className: "flex items-center gap-3 px-4 py-2 rounded-lg bg-white/95 border border-gray-200 border-l-4", style: { borderLeftColor: "#138808" }, children: [_jsxs("div", { className: "flex flex-col", children: [_jsx("span", { className: "text-xs text-gray-500 uppercase tracking-wider font-semibold", children: t("patrolCommand") }), _jsx("span", { className: "text-xs text-gray-500", children: t("autoDispatchAlerts") })] }), _jsx(Switch, { checked: autoDispatch, onCheckedChange: setAutoDispatch, className: "data-[state=checked]:bg-blue-600" })] })] }), _jsxs("div", { className: "relative", children: [_jsx("div", { ref: mapRef, className: "w-full bg-gray-100", style: { height: '600px' } }), _jsxs("div", { className: "absolute bottom-6 left-6 bg-white/95 border border-gray-200 rounded-lg p-4 shadow-sm z-10", children: [_jsx("p", { className: "text-xs font-semibold text-gray-900 mb-3", children: t("riskLevel") }), _jsxs("div", { className: "space-y-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-green-500" }), _jsx("span", { className: "text-xs text-gray-600", children: t("lowRisk") })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-amber-500" }), _jsx("span", { className: "text-xs text-gray-600", children: t("mediumRisk") })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-orange-500" }), _jsx("span", { className: "text-xs text-gray-600", children: t("highRisk") })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("div", { className: "w-4 h-4 rounded-full bg-red-500" }), _jsx("span", { className: "text-xs text-gray-600", children: t("criticalRisk") })] })] })] }), selectedPrediction && (_jsxs("div", { className: "absolute top-6 right-6 bg-white/95 border border-gray-200 rounded-lg p-4 shadow-sm max-w-sm z-10", children: [_jsxs("div", { className: "flex items-center gap-2 mb-3", children: [_jsx("div", { className: "w-2 h-2 rounded-full bg-blue-600 animate-pulse" }), _jsx("p", { className: "text-xs font-semibold text-gray-900", children: t("livePrediction") })] }), _jsxs("p", { className: "text-sm font-bold text-gray-900 mb-2", children: [selectedPrediction.city, " \u2022 ", getTimeLabel(selectedPrediction.hour)] }), _jsxs("div", { className: "text-xs space-y-1 text-gray-600", children: [_jsxs("p", { children: [_jsxs("span", { className: "text-gray-500", children: [t("riskLevel"), ":"] }), " ", _jsx("span", { style: { color: getRiskColor(selectedPrediction.riskLevel).hex }, className: "font-semibold", children: selectedPrediction.riskLevel })] }), _jsxs("p", { children: [_jsxs("span", { className: "text-gray-500", children: [t("riskScore"), ":"] }), " ", selectedPrediction.predictedRate.toFixed(1)] }), _jsxs("p", { children: [_jsxs("span", { className: "text-gray-500", children: [t("crimeType"), ":"] }), " ", selectedPrediction.crimeType] }), _jsxs("p", { children: [_jsxs("span", { className: "text-gray-500", children: [t("confidence"), ":"] }), " 94.2%"] })] })] }))] })] }), _jsxs("div", { id: "patrol-command-section", className: "pt-6 border-t border-gray-200", children: [_jsxs("div", { className: "flex items-center gap-3 mb-6", children: [_jsx("div", { className: "p-2 rounded-lg bg-white/95 border border-gray-200 border-l-4", style: { borderLeftColor: "#000080" }, children: _jsx(Shield, { className: "w-5 h-5 text-gray-700" }) }), _jsxs("div", { children: [_jsx("h2", { className: "text-xl font-semibold text-gray-900 uppercase tracking-tight", children: t("tacticalOperations") }), _jsx("p", { className: "text-xs text-gray-500", children: t("tacticalOpsSubtitle") })] })] }), _jsx(PatrolCommand, {})] })] }));
}
