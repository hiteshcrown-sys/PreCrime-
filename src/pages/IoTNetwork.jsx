            ...
            <div className="rounded-lg p-4 border-2 bg-gray-50" style={{ borderColor: GOV_BORDER }}>
              <div className="flex items-center justify-between">
                <span className="text-base font-bold text-gray-800">
                  🔴 <strong>{t("circuitStatus")}:</strong> {alerts.length > 0 ? t("buzzerTriggered").replace("{count}", alerts.length.toString()) : t("monitoringForSounds").replace("{threshold}", GUNSHOT_THRESHOLD.toString())}
                </span>
              </div>
              {alerts.length > 0 && (
